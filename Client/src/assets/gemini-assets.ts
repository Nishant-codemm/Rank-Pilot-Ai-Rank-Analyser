...
export const createSeoAnalysisPrompt = (scrapedData: ScrapedData) => `You are an expert SEO analyst. Analyze the following website data and provide a comprehensive SEO audit.
